...
public class SuccessTestIntentService extends IntentService {
    public static final String TAG4C = "TestService";
    public static final MediaType JSON = MediaType.parse("application/json; charset=utf-8");
    OkHttpClient client = new OkHttpClient();
    String uid = null, sid = null, timestamp = "123456", fenceID = "333@TNM", username = null;

    public SuccessTestIntentService() {
        super(SuccessTestIntentService.class.getName());
    }

    @Override
    protected void onHandleIntent(Intent intent) {
        Log.d(TAG4C, "STService start");
        ...
        if (MenuActivity.testPD.isShowing()) {
            MenuActivity.testPD.dismiss();
        }
        Log.d(TAG4C, "STService stop");
    }
    ...
    public void onTriggerSuccess(Context context){
        ...
        notificationManager2.notify(5, builder2.build());
    }
    ...
    public void onTriggerFailed(Context context){
        ...
        builder2.setSound(sound);
        NotificationManager notificationManager2 = (NotificationManager)context.getSystemService(context.NOTIFICATION_SERVICE);
        notificationManager2.notify(6, builder2.build());
    }
}
